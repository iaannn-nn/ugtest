module.exports = (function() {
  ...
  class Graph {
    ...
    unit(uniqid) {  /// grab an unit by their id
    ...
    _addNode(node) {
      ...
      let nodeList = this.nodes(node.entity); // let is to declare locally
      return nodeList._add(node);             // var is to declare globally
    }
    ...
    _getPath(node, traced) {
      ...
      return path;/// there must be a path object out there
    }
